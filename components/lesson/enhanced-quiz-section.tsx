...
import { CheckCircle2, XCircle, Lightbulb, AlertTriangle, Lock, Shield, Clock } from "lucide-react"
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
const ProctoringSetup = dynamic(() => import("./proctoring-setup"), {
    loading: () => <div className="p-8 text-center text-muted-foreground">Loading AI Proctoring System...</div>,
    ssr: false // AI models rely on window/navigator
})

const ProctoringMonitor = dynamic(() => import("./proctoring-monitor"), {
    ssr: false
})
...
export default function EnhancedQuizSection({ quizzes, courseId, lessonId, initialQuizScore }: QuizSectionProps) {
    ...
    }, [timeLeft, submitted, showResults, handleSubmit])
                ...
                <CardHeader>
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <Badge className={`${timeLeft < 60 ? "bg-red-500 animate-pulse" : "bg-primary"} text-white border-primary`}>
